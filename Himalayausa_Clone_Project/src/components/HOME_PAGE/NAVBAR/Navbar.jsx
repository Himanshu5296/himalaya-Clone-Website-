        ...
        <div className="navbar-nav">
            <div className={close ? 'side-bar':"side-bar2"}>
                ...
                <div className='nav-data'>
                    ...
                    <a className='LINK' href="https://www.instagram.com/himalayausa/" target={'_blank'} onClick={(()=>(setClose(false)))}>About</a>
                    <br />
            ...
            <nav className='wrapper'>
                ...
                <div className='nav-links'>
                    ...
                    <a className='LINK' href="https://www.instagram.com/himalayausa/" target={'_blank'}>About</a>
                ...
                <div className="rightside-icons">
                    ...
                    <div className='hover_drop-down'>
                        ...
                        <div className='mini_drop-box'>
                            <div className='grid'>
                                <Link className='link-l' to={'/SignIn'}>Sign In/Register</Link>
                                <Link className='link-l' to={'/Login'}>Login</Link>
