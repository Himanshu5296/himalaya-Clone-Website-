...

{
   ...
   price : 20.95,
   category : "HealthInterests",
   description : "If you're seeking gentle, reliable colon cleansing and relief from occasional constipation, without the purging and cramping of other herbs you’ve tried, Himalaya’s ComfortCleanse with no Senna and no Cascara..."
},
...

{
   ...
   price :23.99,
   category : "HealthInterests",
   description : "Say hello to joy and goodbye to blues! Hello Joy® supports mood and emotional wellness when you need it most. No matter what we face in our day, our ability..."
},

{
   ...
   price :5.99,
   category : "OralCare",
   description : "Did you know that Neem and Pomegranate are two of history’s most famous traditional choices for cleaning? Neem and Pomegranate help fight plaque, brighten your teeth, and leave your mouth..."
},
{
   ...
   price :4.99,
   category : "OralCare",
   description : "It’s time to make brushing fun! With a fantastically-foamy bubble gum flavor that keeps young brushers coming back for more, our Kids Bubble Gum Toothpaste is a treat that will..."
},
{
   ...
   price :5.99,
   category : "OralCare",
   description : "Brace yourself! Our Whitening Complete Care Simply Peppermint Toothpaste offers a wide-awake Peppermint flavor with the antioxidants of Pomegranate and enzymes from Papaya and Pineapple to help whiten your teeth,..."
},
{
   ...
   price :39.95,
   category : "HerbalSupplements",
   description : "FlorAvani is the plant-based alternative to probiotics, and it works in ways that probiotics can't. Instead of simply trying to add new strains of bacteria to your intestines, FlorAvani feeds..."
...
},
{
   ...
   price :15.95,
   category : "HerbalSupplements",
   description : "Not only is Guggul famous throughout history for toning digestion and supporting the liver and immune system, this dried resin extract from the Mukul Myrrh tree, with its well-known guggulsterones,..."
},
